...
EOF
  ...
  git add .
  git commit -m "Update Blog By TravisCI With Bu

  git push --force --quiet "https://${GH_TOKEN}@${GH_REF}" master:master
  # Gitee Pages
  git push --force --quiet "https://hitime-wik:${GITEE_TOKEN}@${GITEE_REF}" master:master
  ...
  # Gitee Pages
  git push --quiet "https://hitime-wiki:${GITEE_TOKEN}@${GITEE_REF}" master:master --tags
}
